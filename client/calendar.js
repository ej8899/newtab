// original source: https://codepen.io/ceruulean/pen/xxbwPWO
...
get selectedDates(){
  let result = "";
    this.currentDates.forEach(d=> {
      ...
      result += `${d.dataset.year}-${d.dataset.month}-${d.innerHTML}`;
    })
...
let init = () => {
  ...
  myCal.mount(document.getElementById("thecalendar"));
